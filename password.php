...
<![endif]-->
<!--script src="src/DynamicTables.js"></script>
      ...
      <div class="box-body col-sm-4 col-sm-offset-4 col-xs-12">
        ...
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Recover your password</h3>
          </div>
          <!-- /.box-header -->
          <!-- form start -->
			    <form id="findPassForm" name="findPassForm" action="/findPassword" method="post" onsubmit="return validateForm()">
            <div class="box-body">
              <div class="form-group">
                <label for="inputEmail">Email address</label>
                <input type="email" class="form-control" id="inputEmail" placeholder="Enter email"  name='email' onblur="validateEmail()" required>
				<div id="errEmail"></div>
              </div>
  ...
  <script>		
		function validateEmail() {
			...
			if (!pattern.test(email.val())) {
				//email.focus();
				$('#errEmail').html("<span class=msg>youremail@example.com</span>");
				return false;
			} else {
				$('#errEmail').html();
				return true;
